 ...
 * @author Aluno
 */
public class ProfessorColumnModel extends DefaultTableColumnModel {
    private TableColumn criaColuna(int columnIndex, int largura,
        ...
        col.setCellRenderer(new ProfessorCellRenderer());
    ...
    public ProfessorColumnModel(FontMetrics fm) {
        ...
        addColumn(criaColuna(2, 20 * letra, fm, false, "Titulação"));
        addColumn(criaColuna(3, 20 * letra, fm, false, "Salário"));
    }
}
